        ...
        if username and password:
            ...
            if self.user_cache is None:
                raise forms.ValidationError(
                    _("Please enter a correct email/username and password. Note that both fields are case-sensitive."))
...
class PasswordResetForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if not IS_EMAIL_CONFIGURED:
            raise forms.ValidationError(
                _(u'Failed to send email, email service is not properly configured, please contact administrator.'))
